...
def marglik_optimization(model,
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        for data in tqdm(train_loader):
            ...
            #NOTE: MAP Estimation: the second term is the prior regularization, the delta corresponds to the prior precision (inverse covariance) and hence the term say for weigt_decay would just be (\lambda * theta^2), which is L2-normalization
